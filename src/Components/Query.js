...
function Query() {
    ...
    const scriptURL = 'https://script.google.com/macros/s/AKfycbxpCsI7QjCdzLzBIF5r_aXhsKh4GiAZwEGArtTTb8NVSWyvJ07BT3b8vax7XOOnLVMh/exec'

    //use state to handle form datas whenever they are changed
    const [formData, setFormData] = useState({
        // Initialize form data here if needed
        name: "", mobile: "", email: "",state: "", district: "", stream: "", class: ""
    });
    ...
    const handleSubmit = async (e) => {
        ...
        if (response.ok) {
            alert("Thanks for requesting call back. We will contact you soon !");
  ...
  return (
    <>
        <div className="container">
            ...
            <button type="button" id="callbtn" onClick={callNow}><i className="fa fa-phone"></i> Call now for free</button>
            <h1>or</h1>


            <h2>Request call back</h2>
            <form method='post' onSubmit={handleSubmit} id="queryForm" name="queryForm" >
                <input type="text" id="name" name="name" placeholder="Name*" onChange={handleChange} value={formData.name} className="input-half" required />
                <div className="form-group">
                    <input type="number" id="mobile" name="mobile" placeholder="Mobile No*" onChange={handleChange} value={formData.mobile} className="input-half" required />
                    <input type="email" id="email" name="email" placeholder="Email Id*" onChange={handleChange} value={formData.email} className="input-half" required />
                </div>
            
                <div className="form-group">
                    <select id="state" name="state" onChange={updateDistricts} value={formData.state}  required>
                    ...
                    <select id="district" name="district" onChange={handleChange} value={formData.district} className="input-half" required>
                ...
                <div className="form-group">
                    <select id="stream" name="stream" onChange={handleChange} value={formData.stream} className="input-half" required>
                    ...
                    <select id="class" name="class" onChange={handleChange} value={formData.class} className="input-half" required>
                ...
                <label>
                    <input type="checkbox" id="agree" name="agree" placeholder="hgcfjf" required />
                    I agree
                </label>
